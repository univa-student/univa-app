...
export const tabs: TabDef[] = [
    { id: "account", groupId: SETTING_GROUP.USER, label: "Акаунт", icon: UserIcon, description: "Особисті дані", group: "Загальне" },
    ...
    { id: "danger", groupId: SETTING_GROUP.DANGER_ZONE, label: "Небезпечна зона", icon: Trash2Icon, description: "Видалення акаунту" },
]
